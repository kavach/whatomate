...
const providerColors: Record<string, string> = {
  google:
    "hover:bg-red-950 border-red-800 light:hover:bg-red-50 light:border-red-200",
  microsoft:
    "hover:bg-blue-950 border-blue-800 light:hover:bg-blue-50 light:border-blue-200",
  github:
    "hover:bg-gray-800 border-gray-600 light:hover:bg-gray-100 light:border-gray-300",
  facebook:
    "hover:bg-blue-950 border-blue-800 light:hover:bg-blue-50 light:border-blue-200",
  custom:
    "hover:bg-purple-950 border-purple-800 light:hover:bg-purple-50 light:border-purple-200",
};
...
<template>
  <div
    class="min-h-screen flex items-center justify-center bg-[#0a0a0b] light:bg-gradient-to-br light:from-gray-50 light:to-gray-100 p-4"
  >
    <div
      class="w-full max-w-md rounded-2xl border border-white/[0.08] bg-white/[0.02] backdrop-blur light:bg-white light:border-gray-200 light:shadow-xl"
    >
      <div class="p-8 space-y-1 text-center">
        <div class="flex justify-center mb-4">
          <img :src="logoImage" alt="Logo" class="h-24 w-24 object-contain" />
        </div>
      ...
      <form @submit.prevent="handleLogin">
        <div class="px-8 pb-4 space-y-4">
          ...
          <Button
            type="submit"
            class="w-full bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white shadow-lg shadow-emerald-500/20"
            :disabled="isLoading"
          >
      ...
      <div v-if="ssoProviders.length > 0" class="px-8 pb-4 space-y-3">
        ...
        >
          <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
            <path
              :d="providerIcons[provider.provider] || providerIcons.custom"
            />
          </svg>
          {{ provider.name }}
        </Button>
